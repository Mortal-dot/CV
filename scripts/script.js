document.addEventListener('DOMContentLoaded', function() {
    ...
    if (textElement) {
        const texts = [
            "Auditorías de Gestion de dinero.",
            "Desarrollo web confiables y seguros.",
            "Gestión de Activos, pasivos, patrimonios.",
            "Estudiante de Bancas y Finanzas, contabilidad, trading, etc.",
            "TradingView.",
            "Estudiante de Criptomonedas."
